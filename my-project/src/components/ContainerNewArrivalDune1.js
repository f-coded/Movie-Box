...
const ContainerNewArrivalDune1 = memo(() => {
  return (
    <div className="absolute top-[1347px] left-[34px] w-[1368px] h-[532px] text-left text-xs text-gray-900 font-dm-sans">
      <div className="absolute top-[19px] left-[66px] flex flex-row items-start justify-start gap-[80px]">
        <div className="flex flex-col items-start justify-start gap-[12px]">
          <div className="relative w-[250px] h-[370px]">
            <img
              className="absolute top-[0px] left-[0px] w-[250px] h-[370px] object-cover"
              alt=""
              src="/poster-image1@2x.png"
            />
        ...
        <div className="flex flex-col items-start justify-start gap-[12px]">
          ...
          <b className="relative text-gray-400">Action, Adventure, Thriller</b>
        </div>
        <div className="flex flex-col items-start justify-start gap-[12px]">
          <div className="relative w-[250px] h-[370px]">
            <img
      ...
      <img
        className="absolute top-[-385px] left-[1320px] w-12 h-12 overflow-hidden"
        alt=""
        src="/chevron-right.svg"
      />
      <img
        className="absolute top-[315px] left-[0px] w-12 h-12 overflow-hidden"
        alt=""
        src="/chevron-right.svg"
      />
    </div>
